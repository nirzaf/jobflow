      ...
      <div className="grid gap-4 sm:gap-6">
        {candidates.map((candidate) => (
          ...
          >
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                ...
                <div className="space-y-2">
                  {candidate.notes.map((note) => (
                    <p key={note.id} className="text-sm text-gray-600 break-words">
                      {note.content}
                    </p>
                  ))}
                </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 flex flex-col sm:flex-row gap-2 sm:justify-end">
